...
\fbox{
  \begin{minipage}{\textwidth}
    ...
    \makebox[\textwidth]{\large Student number: 101090782\enspace\hrulefill}\\
  \end{minipage}
}
...
\begin{parts}
  ...
  \makenonemptybox{130pt}{
   ...
   \paragraph{} We prove that $B = \varnothing$. Assume, for the sake of contradiction, that $B \neq \varnothing$. Then there exists a point $(a,b,c) \in B$ such that
       ...
       \end{itemize}
    Hence, $\mathcal{B}_3 - \beta \mathcal{B}_2$ is \textbf{TRUE} for all $\beta \in \mathbb{R}$. This implies there exist $(a,b,c)$ s.t.: $3a + 2b + c = 5$ is \textbf{TRUE}. It follows from $\mathcal{A}_3: 3a + 2b + c = 5$ and that $\mathcal{B}_2 = \mathcal{A}_2$ and that $\mathcal{B}_1 = \mathcal{A}_1$ are all \textbf{TRUE}. Thus, $A \neq \varnothing$, a contradiction. Therefore, $B = \varnothing$.
...
% end of your answer to case 1 unless you need to continue the answer on page 4
  ...
  \makenonemptybox{130pt}{
   ...
   \paragraph{} We prove that $A = \varnothing$. Assume, for the sake of contradiction, that $A \neq \varnothing$. Then there exists a point $(a,b,c) \in A$ such that $\mathcal{A}_1$, $\mathcal{A}_2$, and $\mathcal{A}_3$ are \textbf{TRUE}. Thus:
       ...
       \end{itemize}
    Hence, $\mathcal{B}_3 = \mathcal{A}_3 + \beta \mathcal{A}_2$ is \textbf{TRUE} for all $\beta \in \mathbb{R}$. It follows from $\mathcal{A}_2 = \mathcal{B}_2$ and that $\mathcal{A}_1 = \mathcal{B}_1$ are all \textbf{TRUE}. Thus, $B \neq \varnothing$, a contradiction. Therefore, $A = \varnothing$.
...
\makenonemptybox{400pt}{
    %%% Your work goes here!  It is your responsibility to trim down your answer so that it doesn't 
    %%% run into the next question or off the bottom of the page (and don't get too close to the bottom
    %%% either, please!)
